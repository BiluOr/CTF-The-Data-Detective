...
משחק "תפוס את הדגל" מבוסס דפדפן, השחקנים נכנסים לנעליו של בלש נתונים המפעיל דשבורד פיננסי.<br>
המטרה היא לפתור 10 משימות חקר נתונים על מנת למצוא מזהי עסקאות, חריגות במערכת ומדדי ביצוע.
</p>

<p align="right" dir="rtl">
<strong>מטרה לימודית:</strong> המשחק בנוי כמשחק לימודי. הוא ברמה בסיסית והוא בא במטרה להנגיש את ניתוח הנתונים ושימוש בדשבורד בצורה חווייתית, כיפית וקלילה.
</p>
...
<ul align="right" dir="rtl">
  ...
  <li><strong>10 שלבים מאתגרים:</strong> המשימות נעות מבידוד נתונים בסיסי ועד לחישובים וחיפוש נתונים חריגים.</li>
</ul>
...
<ul align="right" dir="rtl">
  ...
  <li><strong>בחינת הנתונים הגולמיים:</strong> ירידה לפרטים בטבלת הנתונים כדי למצוא מזהים ספציפיים, לאתר חריגות ולבצע חישובים </li>
</ul>
